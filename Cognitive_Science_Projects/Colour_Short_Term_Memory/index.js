...
function createStartButton(){
    ...
    fill(0,0,0);
    textSize(20);
    var introText = text("In this experiment, I aim to find out what text colour aids in Short Term Memory. Click on a colour and you will be taken to a page with 12 words, written in the text colour you chose. You will have 25 seconds to memorise as many words as you can. After the 25 seconds, there is a 20 second down timer where you can try to recall all the words you have seen. Then, you will be taken to a prompt where you will be asked to write as many words as you remember. Good Luck!", width/2 - 600, 300,500,500);
