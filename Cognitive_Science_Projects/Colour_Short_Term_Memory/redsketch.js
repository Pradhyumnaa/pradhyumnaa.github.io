...
function setup() {
    ...
    letters_for_red = [random(four_letter), random(four_letter), random(four_letter), random(four_letter), random(four_letter), random(five_letter), random(five_letter), random(five_letter), random(five_letter), random(five_letter), random(six_letter), random(six_letter), random(six_letter), random(six_letter), random(six_letter)];
...
function redText(){
    ...
    noStroke();
    textSize(21);
    text(letters_for_red[0],width/2,50);
    text(letters_for_red[5],width/2,100);
    text(letters_for_red[10],width/2,150);
    
    text(letters_for_red[1],width/2,200);
    text(letters_for_red[6],width/2,250);
    text(letters_for_red[11],width/2,300);
    
    text(letters_for_red[2],width/2,350);
    text(letters_for_red[7],width/2,400);
    text(letters_for_red[12],width/2,450);
    
    text(letters_for_red[3],width/2,500);
    text(letters_for_red[8],width/2,550);
    text(letters_for_red[13],width/2,600);
    
    text(letters_for_red[4],width/2,650);
    text(letters_for_red[9],width/2,700);
    text(letters_for_red[14],width/2,750);
